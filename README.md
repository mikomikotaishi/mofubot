# Mofubot
<div align="center">
    <img src="./assets/mofubot.png" alt="Bot profile picture" width="25%">
</div>

## Overview
A general-use Discord bot, written in Java with [JDA (Java Discord API)](https://github.com/discord-jda/JDA) and C++ (via `java.lang.foreign`).
